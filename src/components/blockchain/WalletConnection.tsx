...
export const WalletConnection = ({ showBalance = true, className }: WalletConnectionProps) => {
  return (
                ...
                return (
                  <div className="flex items-center gap-2">
                    <button
                      onClick={openChainModal}
                      type="button"
                      className="flex items-center gap-2 bg-secondary text-secondary-foreground hover:bg-secondary/90 px-3 py-2 rounded-lg font-medium transition-colors"
                    >
                      {chain.hasIcon && (
                        <div
                          style={{
